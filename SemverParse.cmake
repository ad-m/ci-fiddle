...
function(semver_parse VERSION_STRING RETURN_NAME)
  ...
  if (${CMAKE_MATCH_COUNT} EQUAL ${semver_pre_release_match_group} OR ${CMAKE_MATCH_COUNT} GREATER ${semver_pre_release_match_group})
  ...
  if (${CMAKE_MATCH_COUNT} EQUAL ${semver_build_match_group} OR ${CMAKE_MATCH_COUNT} GREATER ${semver_build_match_group})
